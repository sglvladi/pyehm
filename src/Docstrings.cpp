...
tree: :class:`~.EHM2Tree`
    ...
    {
        return R"(__init__(root: pyehm.net.EHMNetNode, validation_matrix: numpy.ndarray, tree: pyehm.net.EHM2Tree)";
    }
...
detection: :class:`int`
    ...
    std::string EHM2Tree()
    {
        return R"(EHM2Tree(track: int, children: List[EHM2Tree], detections: Set[int])
